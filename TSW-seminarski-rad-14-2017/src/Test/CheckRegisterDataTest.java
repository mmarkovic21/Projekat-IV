...
import java.net.URL;
public class CheckRegisterDataTest {
  ...
  public void checkRegisterData() {
    ...
    // Provera podataka profila
    	assertThat(driver.findElement(By.xpath("//div[3]/div[2]/div/div/div[2]/p")).getText(), is ("Marija Markovic\nmarijaamarkovic21@gmail.com\nIzmeni lozinku"));
    	assertThat(driver.findElement(By.cssSelector(".col-1 > address")).getText(), is ("Marija Markovic\nNemanjina 80\nNemanjina 80\nCacak, 32000\nSrbija\nT: 0658210698\nPromeni adresu"));
    	assertThat(driver.findElement(By.xpath("//div[2]/address")).getText(), is ("Marija Markovic\nNemanjina 80\nNemanjina 80\nCacak, 32000\nSrbija\nT: 0658210698\nPromeni adresu"));
